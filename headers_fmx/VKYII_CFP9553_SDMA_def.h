...
#define SDMA_CTRL_REG0            (*(volatile unsigned char *)0xAF0420)
...
#define SDMA_SRC_ADDY_L          (*(volatile unsigned char *)0xAF0422)  // Pointer to the Source of the Data to be stransfered
#define SDMA_SRC_ADDY_M          (*(volatile unsigned char *)0xAF0423)  // This needs to be within CPU's system RAM range ($00_0000 - $3F_FFFF)
#define SDMA_SRC_ADDY_H          (*(volatile unsigned char *)0xAF0424)

#define SDMA_DST_ADDY_L          (*(volatile unsigned char *)0xAF0425)  // Destination Pointer within CPU's video memory Range
#define SDMA_DST_ADDY_M          (*(volatile unsigned char *)0xAF0426)  // This needs to be within CPU's system RAM range ($00_0000 - $3F_FFFF)
#define SDMA_DST_ADDY_H          (*(volatile unsigned char *)0xAF0427)

// In 1D Transfer Mode
#define SDMA_SIZE_L              (*(volatile unsigned char *)0xAF0428)  // Maximum Value: $40:0000 (4Megs)
#define SDMA_SIZE_M              (*(volatile unsigned char *)0xAF0429)
#define SDMA_SIZE_H              (*(volatile unsigned char *)0xAF042A)
#define SDMA_IGNORED             (*(volatile unsigned char *)0xAF042B)

// In 2D Transfer Mode
#define SDMA_X_SIZE_L            (*(volatile unsigned char *)0xAF0428)  // Maximum Value: 65535
#define SDMA_X_SIZE_H            (*(volatile unsigned char *)0xAF0429)
#define SDMA_Y_SIZE_L            (*(volatile unsigned char *)0xAF042A)  // Maximum Value: 65535
#define SDMA_Y_SIZE_H            (*(volatile unsigned char *)0xAF042B)

#define SDMA_SRC_STRIDE_L        (*(volatile unsigned char *)0xAF042C)  // Always use an Even Number ( The Engine uses Even Ver of that value)
#define SDMA_SRC_STRIDE_H        (*(volatile unsigned char *)0xAF042D)  //
#define SDMA_DST_STRIDE_L        (*(volatile unsigned char *)0xAF042E)  // Always use an Even Number ( The Engine uses Even Ver of that value)
#define SDMA_DST_STRIDE_H        (*(volatile unsigned char *)0xAF042F)  //

#define SDMA_BYTE_2_WRITE        (*(volatile unsigned char *)0xAF0430)  // Write Only - Byte to Write in the Fill Function
#define SDMA_STATUS_REG          (*(volatile unsigned char *)0xAF0430)  // Read only
