...
//Read/Write
#define FP_MATH_CTRL0  (*(volatile unsigned char *)0xAFE200)
...
#define FP_MATH_CTRL1  (*(volatile unsigned char *)0xAFE201)
...
#define FP_MATH_CTRL2  (*(volatile unsigned char *)0xAFE202)  // Not Used - Reserved
#define FP_MATH_CTRL3  (*(volatile unsigned char *)0xAFE203)  // Not Used - Reserved
//Read Only
#define FP_MATH_MULT_STAT  (*(volatile unsigned char *)0xAFE204)
...
#define FP_MATH_DIV_STAT   (*(volatile unsigned char *)0xAFE205)
...
#define FP_MATH_ADD_STAT   (*(volatile unsigned char *)0xAFE206)
...
#define FP_MATH_CONV_STAT  (*(volatile unsigned char *)0xAFE207)
...
#define FP_MATH_INPUT0_LL  (*(volatile unsigned char *)0xAFE208)
#define FP_MATH_INPUT0_LH  (*(volatile unsigned char *)0xAFE209)
#define FP_MATH_INPUT0_HL  (*(volatile unsigned char *)0xAFE20A)
#define FP_MATH_INPUT0_HH  (*(volatile unsigned char *)0xAFE20B)
//Write Input1 (either FP or Fixed (20.12)) - See MUX Setting
#define FP_MATH_INPUT1_LL  (*(volatile unsigned char *)0xAFE20C)
#define FP_MATH_INPUT1_LH  (*(volatile unsigned char *)0xAFE20D)
#define FP_MATH_INPUT1_HL  (*(volatile unsigned char *)0xAFE20E)
#define FP_MATH_INPUT1_HH  (*(volatile unsigned char *)0xAFE20F)
//Read Output
#define FP_MATH_OUTPUT_FP_LL  (*(volatile unsigned char *)0xAFE208)
#define FP_MATH_OUTPUT_FP_LH  (*(volatile unsigned char *)0xAFE209)
#define FP_MATH_OUTPUT_FP_HL  (*(volatile unsigned char *)0xAFE20A)
#define FP_MATH_OUTPUT_FP_HH  (*(volatile unsigned char *)0xAFE20B)
//Read FIXED Output (20.12) Format
#define FP_MATH_OUTPUT_FIXED_LL  (*(volatile unsigned char *)0xAFE20C)
#define FP_MATH_OUTPUT_FIXED_LH  (*(volatile unsigned char *)0xAFE20D)
#define FP_MATH_OUTPUT_FIXED_HL  (*(volatile unsigned char *)0xAFE20E)
#define FP_MATH_OUTPUT_FIXED_HH  (*(volatile unsigned char *)0xAFE20F)
