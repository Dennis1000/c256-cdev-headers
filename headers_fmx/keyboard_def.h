...
// Register addresses
#define STATUS_PORT 	 (*(volatile unsigned char *)0xAF1064)
#define KBD_OUT_BUF 	 (*(volatile unsigned char *)0xAF1060)
#define KBD_INPT_BUF	 (*(volatile unsigned char *)0xAF1060)
#define KBD_CMD_BUF		 (*(volatile unsigned char *)0xAF1064)
#define KBD_DATA_BUF	 (*(volatile unsigned char *)0xAF1060)
#define PORT_A		     (*(volatile unsigned char *)0xAF1060)
#define PORT_B			 (*(volatile unsigned char *)0xAF1061)
