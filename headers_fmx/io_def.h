...
// SD Card CH376S Port
#define SDCARD_DATA    (*(volatile unsigned char *)0xAFE810)  //(R/W) SDCARD (CH376S) Data PORT_A (A0 = 0)
#define SDCARD_CMD     (*(volatile unsigned char *)0xAFE811)  //(R/W) SDCARD (CH376S) CMD/STATUS Port (A0 = 1)

// SD Card Card Presence / Write Protect Status Reg
#define SDCARD_STAT    (*(volatile unsigned char *)0xAFE812)  //(R) SDCARD (Bit[0] = CD, Bit[1] = WP)
...
#define CODEC_DATA_LO  (*(volatile unsigned char *)0xAFE900)  //(W) LSB of Add/Data Reg to Control CODEC See WM8776 Spec
#define CODEC_DATA_HI  (*(volatile unsigned char *)0xAFE901)  //(W) MSB od Add/Data Reg to Control CODEC See WM8776 Spec
#define CODEC_WR_CTRL  (*(volatile unsigned char *)0xAFE902)  //(W) Bit[0] = 1 -> Start Writing the CODEC Control Register
